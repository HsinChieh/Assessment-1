...
##### In this question, there are two types of variables(one is restaurant and another is total_fat). 
##### In ggplot2 cheat sheet, we need to identify the variables belong to discrete, continuous, both discrete or both continuous. 
##### Because restaurant belongs to `discrete` and total_fat belongs to `continuous`, I choose the bar chart for easy understanding the difference between each restaurant.
...
as.factor(fastfood$calories)
is.factor(fastfood$cal_fat)
is.factor(fastfood$total_fat)
is.factor(fastfood$sat_fat)
is.factor(fastfood$trans_fat)
is.factor(fastfood$cholesterol)
is.factor(fastfood$sodium)
is.factor(fastfood$total_carb)
is.factor(fastfood$fiber)
is.factor(fastfood$sugar)
is.factor(fastfood$protein)
is.factor(fastfood$vit_a)
is.factor(fastfood$vit_c)
is.factor(fastfood$calcium)
is.factor(fastfood$salad)
